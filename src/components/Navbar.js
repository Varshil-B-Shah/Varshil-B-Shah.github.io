...
const Navbar = () => {
  return (
    <div>
      <div className="h-20 md:flex justify-center items-center w-svw lg:px-14 py-3 bg-gray-200 hidden">
        <div className="lg:flex-1">
          <img
            src="nexcent-logo.png"
            alt="Nexcent logo"
            className="scale-50 p-4 md:m-0"
          />
        </div>
        <div className="lg:mr-14 md:mr-16 lg:p-2 hidden md:flex">
          <ul className="md:flex items-center justify-center md:gap-5 lg:gap-10 gap-2">
            <li className="font-bold text-xs md:text-base lg:text-base">
              Home
            </li>
            <li className="font-bold text-xs md:text-base lg:text-base">
              Features
            ...
            <li>
              <button className="bg-green-600 rounded-lg lg:py-2 lg:px-9 md:py-1 md:px-4 text-white hover:bg-green-700 flex items-center justify-center gap-3">
      ...
      <div className="h-20 justify-center items-center w-svw py-3 bg-gray-200 md:hidden flex gap-9">
